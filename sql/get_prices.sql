select m.msp_id as identifier, t.slug_name as name, m.name as provider, charge_price.price, t.monhtly_fee as monthly_fee, updated
...
order by provider desc, t.slug_name
